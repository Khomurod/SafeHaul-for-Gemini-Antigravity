...
import { getDisplayLeadName } from '../../../shared/utils/helpers';
    ...
    const sortedData = useMemo(() => {
        ...
        if (sortConfig.key !== null) {
            sortableItems.sort((a, b) => {
                ...
                // Handle Name concatenation (Smart Sort)
                if (sortConfig.key === 'name') {
                    aValue = getDisplayLeadName(a).toLowerCase();
                    bValue = getDisplayLeadName(b).toLowerCase();
                }
