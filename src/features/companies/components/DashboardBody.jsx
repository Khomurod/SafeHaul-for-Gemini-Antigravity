...
import { Trash2, Phone, MessageSquare, Clock, CheckCircle, Zap, Ban, AlertTriangle, CheckCircle2, XCircle, ThumbsDown, Briefcase, Calendar, MapPin, User, Lock } from 'lucide-react';
import { getFieldValue, getStatusColor, formatPhoneNumber, getDisplayLeadName } from '../../../shared/utils/helpers';
...
const getOutcomeConfig = (outcome) => {
    ...
    return { style: 'bg-gray-50 text-gray-500 border-gray-100', icon: Phone };
};
...
export function DashboardBody({
    ...
    return (
        <tbody className="divide-y divide-gray-100 bg-white">
            {data.map(item => {
                const name = getDisplayLeadName(item);
