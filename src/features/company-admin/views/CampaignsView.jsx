...
export function CampaignsView({ companyId }) {
    ...
    useEffect(() => {
        ...
        const fetchPreview = async () => {
            ...
            try {
                ...
                // Status Filter (Simulation for preview, complex Firestore queries need indexes)
                // In production, we'd ensure proper composite indexes exist.
                ...
                if (!isCancelled) setPreviewLeads([]);
            } finally {
    ...
    useEffect(() => {
        if (!selectedSessionId || view !== 'report') return;
        const q = query(
                    ...
                    <div className="space-y-8">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-3">
                                <label className="text-[10px] font-black text-slate-500 uppercase tracking-tighter ml-1">Action Volume</label>
